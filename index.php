  ...
  <nav class="navbar navbar-expand-lg navbar-dark default-color">
    <a class="navbar-brand" href="#"><b>Efficient and Assistant Tool</b></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 py-5 ">
          <h2 class="font-weight-bold">About <br>  Efficienct and Assistant Tool </h2>
          <div class="pr-5">
  ...
  <section class="py-2 bg-dark text-light">
    <div class="container-fluid">
      Copyright 2025 All Rights Reseved. <a href="#" class="text-light"> Efficienct and Assistant Tool </a>
    </div>
  </section>
